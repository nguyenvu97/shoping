            ...
            <div class="aa-product-area">
              <div class="aa-product-inner">
                ...
                <ul class="nav nav-tabs aa-products-tab">
                  <li :class="{ active: activeCategory === 'popular' }">
                    <a href="#" @click.prevent="setCategory('popular')">Popular</a>
                  </li>
                  <li :class="{ active: activeCategory === 'featured' }">
                    <a href="#" @click.prevent="setCategory('featured')">Featured</a>
                  </li>
                  <li :class="{ active: activeCategory === 'latest' }">
                    <a href="#" @click.prevent="setCategory('latest')">Latest</a>
                  </li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" :class="{ 'in': activeCategory === 'popular', 'active': activeCategory === 'popular' }" id="popular">
                    ...
                    <button @click="goToProducts('popular')" class="aa-browse-btn" v-if="product.length > 0">
                  ...
                  <div class="tab-pane fade" :class="{ 'in': activeCategory === 'featured', 'active': activeCategory === 'featured' }" id="featured">
                    ...
                    <button @click="goToProducts('featured')" class="aa-browse-btn" v-if="product.length > 0">
                      Browse all Products <span class="fa fa-long-arrow-right"></span>
                    </button>
                    <div v-else class="no-products-message">
                      <p>No products available</p>
                  ...
                  <div class="tab-pane fade" :class="{ 'in': activeCategory === 'latest', 'active': activeCategory === 'latest' }" id="latest">
                    ...
                    <button @click="goToProducts('latest')" class="aa-browse-btn" v-if="product.length > 0">
                      Browse all Products <span class="fa fa-long-arrow-right"></span>
                    </button>
                    <div v-else class="no-products-message">
                      <p>No products available</p>
